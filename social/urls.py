...
router.register('myprofile', MyProfileViewSet, 'myprofile_api')
router.register('mypost', MyPostViewSet, 'mypost_api')
router.register('postlike', PostLikeViewSet, 'postlike_api')
router.register('followuser', FollowUserViewSet, 'followuser_api')
router.register('addconfession', AddConfessionViewSet, 'addconfession_api')
router.register('vithub', VithubViewSet, 'vithub_api')
router.register('contact', ContactViewSet, 'contact_api')
router.register('chat', ChatViewSet, 'chat_api')
router.register('developer', DeveloperViewSet, 'developer_api')
router.register('poll', PollViewSet, 'poll_api')
router.register('pollvoted', PollVotedViewSet, 'pollvoted_api')
...
urlpatterns = [ 
    ...
    path('profile/edit/<int:pk>',
         views.MyProfileUpdateView.as_view(success_url="/"), name='profileEdit'),
